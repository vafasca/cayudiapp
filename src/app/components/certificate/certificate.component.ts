...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, CommonModule, PdfViewerModule, IonicModule],
...
export class CertificateComponent implements OnInit {
  ...
  selectCertificate(certificate: Certificate): void {
    ...
    // Resetear el PDF URL primero para forzar la recarga del visor
    this.currentPdfUrl = null;
    
    // Usar setTimeout para asegurar que el visor se resetee antes de cargar el nuevo PDF
    setTimeout(() => {
